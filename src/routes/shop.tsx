...
const shopSearchSchema = z.object({
  type: z.enum(['Booster box', 'Special box', 'Figures', 'Single pack']).optional(),
})
  ...
  return (
    <section style={{ maxWidth: 1240, margin: '0 auto', padding: '40px 20px 80px' }}>
      ...
      <p style={{ fontSize: 14.5, color: '#5a6875', margin: '10px 0 0', maxWidth: '62ch' }}>
        Prices in USD. Pre-orders ship within 48 hours of the mainland street date — mixed orders ship together
