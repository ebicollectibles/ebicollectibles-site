...
export function HeaderSearch({
  ...
  return (
    <div
      ...
      style={{ position: 'relative', width: desktop ? 210 : '100%' }}
    >
      <form
        onSubmit={(e) => {
          e.preventDefault()
        ...
        style={{
          ...
          borderRadius: 2,
          padding: desktop ? '8px 12px' : '10px 12px',
          width: '100%',
          background: '#f6f7f8',
        }}
      >
        ...
        <input
          ...
          autoComplete="off"
          style={{ border: 0, background: 'transparent', fontSize: desktop ? 12.5 : 16, width: '100%', color: '#131b28' }}
        />
      </form>
